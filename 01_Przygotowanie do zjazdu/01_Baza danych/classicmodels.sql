...
-- Name: offices; Type: TABLE; ; Owner: postgres
--
...
-- Name: orderdetails; Type: TABLE; ; Owner: postgres
--
...
-- Name: payments; Type: TABLE; ; Owner: postgres
--
...
-- Name: productlines; Type: TABLE; ; Owner: postgres
--
...
ALTER TABLE productlines OWNER TO postgres;

--
-- TOC entry 208 (class 1259 OID 16526)
-- Name: products; Type: TABLE; ; Owner: postgres
--
...
--
-- TOC entry 2999 (class 0 OID 16493)
-- Dependencies: 201
-- Data for Name: customers; Type: TABLE DATA; ; Owner: postgres
--
...
INSERT INTO customers VALUES (121, 'Baane Mini Imports', 'Bergulfsen', 'Jonas ', '07-98 9555', 'Erling Skakkes gate 78', NULL, 'Stavern', NULL, '4110', 'Norway', 1504, 5000);


--
-- TOC entry 3000 (class 0 OID 16499)
-- Dependencies: 202
-- Data for Name: employees; Type: TABLE DATA; ; Owner: postgres
--
...
--
-- TOC entry 3001 (class 0 OID 16502)
-- Dependencies: 203
-- Data for Name: offices; Type: TABLE DATA; ; Owner: postgres
--
...
--
-- TOC entry 3002 (class 0 OID 16507)
-- Dependencies: 204
-- Data for Name: orderdetails; Type: TABLE DATA; ; Owner: postgres
--
...
--
-- TOC entry 3003 (class 0 OID 16510)
-- Dependencies: 205
-- Data for Name: orders; Type: TABLE DATA; ; Owner: postgres
--
...
--
-- TOC entry 3004 (class 0 OID 16516)
-- Dependencies: 206
-- Data for Name: payments; Type: TABLE DATA; ; Owner: postgres
--
...
--
-- TOC entry 3005 (class 0 OID 16519)
-- Dependencies: 207
-- Data for Name: productlines; Type: TABLE DATA; ; Owner: postgres
--
...
--
-- TOC entry 3006 (class 0 OID 16526)
-- Dependencies: 208
-- Data for Name: products; Type: TABLE DATA; ; Owner: postgres
--
...
--
-- TOC entry 2840 (class 2606 OID 16533)
-- Name: customers idx_16837_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY customers
    ADD CONSTRAINT idx_16837_primary PRIMARY KEY (customernumber);


--
-- TOC entry 2844 (class 2606 OID 16535)
-- Name: employees idx_16843_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY employees
    ADD CONSTRAINT idx_16843_primary PRIMARY KEY (employeenumber);


--
-- TOC entry 2847 (class 2606 OID 16537)
-- Name: offices idx_16846_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY offices
    ADD CONSTRAINT idx_16846_primary PRIMARY KEY (officecode);


--
-- TOC entry 2849 (class 2606 OID 16539)
-- Name: orderdetails idx_16851_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY orderdetails
    ADD CONSTRAINT idx_16851_primary PRIMARY KEY (ordernumber, productcode);


--
-- TOC entry 2853 (class 2606 OID 16541)
-- Name: orders idx_16854_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT idx_16854_primary PRIMARY KEY (ordernumber);


--
-- TOC entry 2855 (class 2606 OID 16543)
-- Name: payments idx_16860_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY payments
    ADD CONSTRAINT idx_16860_primary PRIMARY KEY (customernumber, checknumber);


--
-- TOC entry 2857 (class 2606 OID 16545)
-- Name: productlines idx_16863_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY productlines
    ADD CONSTRAINT idx_16863_primary PRIMARY KEY (productline);


--
-- TOC entry 2859 (class 2606 OID 16547)
-- Name: products idx_16870_primary; Type: CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY products
    ADD CONSTRAINT idx_16870_primary PRIMARY KEY (productcode);


--
-- TOC entry 2841 (class 1259 OID 16548)
-- Name: idx_16837_salesrepemployeenumber; Type: INDEX; ; Owner: postgres
--

CREATE INDEX idx_16837_salesrepemployeenumber ON customers USING btree (salesrepemployeenumber);


--
-- TOC entry 2842 (class 1259 OID 16549)
-- Name: idx_16843_officecode; Type: INDEX; ; Owner: postgres
--

CREATE INDEX idx_16843_officecode ON employees USING btree (officecode);


--
-- TOC entry 2845 (class 1259 OID 16550)
-- Name: idx_16843_reportsto; Type: INDEX; ; Owner: postgres
--

CREATE INDEX idx_16843_reportsto ON employees USING btree (reportsto);


--
-- TOC entry 2850 (class 1259 OID 16551)
-- Name: idx_16851_productcode; Type: INDEX; ; Owner: postgres
--

CREATE INDEX idx_16851_productcode ON orderdetails USING btree (productcode);


--
-- TOC entry 2851 (class 1259 OID 16552)
-- Name: idx_16854_customernumber; Type: INDEX; ; Owner: postgres
--

CREATE INDEX idx_16854_customernumber ON orders USING btree (customernumber);


--
-- TOC entry 2860 (class 1259 OID 16553)
-- Name: idx_16870_productline; Type: INDEX; ; Owner: postgres
--

CREATE INDEX idx_16870_productline ON products USING btree (productline);


--
-- TOC entry 2861 (class 2606 OID 16554)
-- Name: customers customers_ibfk_1; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY customers
    ADD CONSTRAINT customers_ibfk_1 FOREIGN KEY (salesrepemployeenumber) REFERENCES employees(employeenumber) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- TOC entry 2862 (class 2606 OID 16559)
-- Name: employees employees_ibfk_1; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY employees
    ADD CONSTRAINT employees_ibfk_1 FOREIGN KEY (reportsto) REFERENCES employees(employeenumber) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- TOC entry 2863 (class 2606 OID 16564)
-- Name: employees employees_ibfk_2; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY employees
    ADD CONSTRAINT employees_ibfk_2 FOREIGN KEY (officecode) REFERENCES offices(officecode) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- TOC entry 2864 (class 2606 OID 16569)
-- Name: orderdetails orderdetails_ibfk_1; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY orderdetails
    ADD CONSTRAINT orderdetails_ibfk_1 FOREIGN KEY (ordernumber) REFERENCES orders(ordernumber) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- TOC entry 2865 (class 2606 OID 16574)
-- Name: orderdetails orderdetails_ibfk_2; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY orderdetails
    ADD CONSTRAINT orderdetails_ibfk_2 FOREIGN KEY (productcode) REFERENCES products(productcode) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- TOC entry 2866 (class 2606 OID 16579)
-- Name: orders orders_ibfk_1; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY orders
    ADD CONSTRAINT orders_ibfk_1 FOREIGN KEY (customernumber) REFERENCES customers(customernumber) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- TOC entry 2867 (class 2606 OID 16584)
-- Name: payments payments_ibfk_1; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY payments
    ADD CONSTRAINT payments_ibfk_1 FOREIGN KEY (customernumber) REFERENCES customers(customernumber) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- TOC entry 2868 (class 2606 OID 16589)
-- Name: products products_ibfk_1; Type: FK CONSTRAINT; ; Owner: postgres
--

ALTER TABLE ONLY products
    ADD CONSTRAINT products_ibfk_1 FOREIGN KEY (productline) REFERENCES productlines(productline) ON UPDATE RESTRICT ON DELETE RESTRICT;


-- Completed on 2021-02-19 11:27:44 UTC
